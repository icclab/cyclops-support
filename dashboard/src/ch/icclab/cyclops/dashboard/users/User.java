...
/**
 * This class provides access to the OpenAM user list
 */
public class User extends ServerResource{

    /**
     * This method updates gets information about the dashboard users from OpenAM
     * <p>
     * The method receives an OpenAM Session ID from the dashboard frontend and uses it to send a request to the OpenAM
     * endpoint configured in /WEB-INF/configuration.txt as OPENAM_LIST_USERS_URL
     * <p>
